...
<blockquote className="twitter-tweet">
  <p lang="en" dir="ltr">
    Hey folks who have a decoupled client-server application (no server rendering, server is just an
    API server). Where is your client code and server code located?
  </p>
  &mdash; Kent C. Dodds (@kentcdodds){' '}
  <a href="https://twitter.com/kentcdodds/status/1036022955849838592?ref_src=twsrc%5Etfw">
    September 1, 2018
  </a>
</blockquote>
