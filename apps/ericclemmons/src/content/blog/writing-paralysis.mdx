---
date: 2015-10-25
summary: Why it's difficult to make time to write.
tags: [writing]
...
Sure, I have the benefit of forgetting all the cruft over the past three years, but the coded products are a testament to years of maintaining the status quo compared to months of growth.
...
- [**Asynchronous Rendering with React**](https://github.com/ericclemmons/react-resolver), because data-dependencies aren’t truly known until all components render. All alternatives to this I’ve seen recommended encourage “fat controllers”, and years of MVC makes this an antipattern for me.
...
Certainly there’s no _need_ to write, as I’d rather talk tech over a latte than battle opinions on an ephemeral blog post.
