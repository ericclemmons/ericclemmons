---
date: 2018-10-18
tags: [api, design, architecture, graphql, node]
summary: Using `class` to abstract complexity in GraphQL resolvers.
title: GraphQL Context & Services
---

[![GraphiQL](https://cdn-images-1.medium.com/max/4232/1*V1-Gltco1Ot3rSvGQq8Bgw.png)](https://codesandbox.io/s/github/ericclemmons/graphql-context-services?module=README.md)
...
> *Note: *You can find the source code for this screenshot & demo at:
