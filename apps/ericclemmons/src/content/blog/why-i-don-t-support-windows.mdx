---
date: 2015-07-04
summary: Dated, incorrect reflection of why Windows wasn't well-supported.
tags: [windows]
...
> No Linux support? Really? — [Hacker News](https://news.ycombinator.com/item?id=9813858)

---

I can’t fault _`thecrumb`_ or for wanting a Linux version, but _expecting_ one is entirely different.
...
Problems and their solutions are so closely tied to the context in which they’re run that it’s quite possible that an _entirely different_ solution would be better suited a different platform.
