    ...
    >
      ...
      <div className="mt-6 flex">
        <input
          ...
          required
          className="min-w-0 flex-auto appearance-none rounded-md border border-zinc-900/10 bg-white px-3 py-[calc(theme(spacing.2)-1px)] shadow-md shadow-zinc-800/5 placeholder:text-zinc-400 focus:border-fuchsia-500 focus:outline-none focus:ring-4 focus:ring-fuchsia-500/10 dark:border-zinc-700 dark:bg-zinc-700/[0.15] dark:text-zinc-200 dark:placeholder:text-zinc-500 dark:focus:border-fuchsia-400 dark:focus:ring-fuchsia-400/10 sm:text-sm"
        />
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: `I'm Eric Clemmons, an engineering leader specializing in autonomous, outcome-driven remote teams with over 15 years of experience as an open-source JavaScript/Node.js developer focused on UX & DX.`,
    },
  ],
};
...
export default function Home({ posts = [] }) {
  return (
    <>
      <div
        className="absolute -mt-16 h-96 w-full bg-fuchsia-500 shadow-inner"
        style={{
