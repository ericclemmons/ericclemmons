...
summary: 'Challenge #17 – Table of Contents Web Component'
draft: true
---

import { TableOfContentsDemo } from '../data/blog/advent-of-javascript/day-17/TableOfContentsDemo'
...
_Looking for Day 11-16? I skipped them because I'm on vacation (and they didn't seem very interesting)._ 🙃
...
For styling, I want to remove everything that exists in the default `styles.css` and let [tailwindcss' `.prose`](https://tailwindcss.com/docs/typography-plugin) takeover.
